...
def main() -> NoReturn:
    ...
    parser.add_argument("--line_points", type=int, default=10000, help="Number of sampling points for 1D plot (default: 10000)")
    parser.add_argument("--image_size", type=int, default=400, help="Size of the 2D image in pixels (default: 400)")
    parser.add_argument("--default_image", type=str, default="sample_images/sample_image.png", help="Path to default sample image")
